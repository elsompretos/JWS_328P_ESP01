...
<table width='100%'>
  <tbody>
    ...
    <tr> 
      <td >Volume Adzan</td>
      <td ><input style='text-align:center' type='number' name='adjvolumeadzan' id='adjvolumeadzan' value='15' min='1' max='99'></td> 
    </tr>
    <tr> 
      <td >Volume Jam</td>
      <td ><input style='text-align:center' type='number' name='adjvolume' id='adjvolume' value='20' min='1' max='99'></td> 
    </tr>
    <tr>
