...
//  int lama_imsak = 5; EEPROM.put(59, lama_imsak);
  EEPROM.get(59, blama_imsak); Serial.print("59 lama_imsak : "); Serial.println(blama_imsak);
  Serial.println(); 
   
  //  KOREKSI HIJRIYAH
  //  ================

//  int sesuaikan_tgl_hijriyah = 1; EEPROM.put(59, sesuaikan_tgl_hijriyah); 
//  int sesuaikan_bright = 10; EEPROM.put(61, sesuaikan_bright);
//  int sesuaikan_volume = 20; EEPROM.put(63, sesuaikan_volume);

  EEPROM.get(61, bsesuaikan_tgl_hijriyah); Serial.print("61 sesuaikan_tgl_hijriyah : "); Serial.println(bsesuaikan_tgl_hijriyah);
  EEPROM.get(63, bsesuaikan_bright); Serial.print("63 sesuaikan_bright : "); Serial.println(bsesuaikan_bright);
  EEPROM.get(65, bsesuaikan_volume); Serial.print("65 sesuaikan_volume : "); Serial.println(bsesuaikan_volume);
  Serial.println();

//  writeString(65, "Masjid Raya Akbar Maulana - Ampera Raya");
//  writeString(115, "Jadikan Sabar dan Sholat Sebagai Penolongmu");
//  writeString(165, "Sedekah Melancarkan Rezekimu");
//  writeString(215, "Subhanallah Walhamdulillah Laailahaillalhah");
//  writeString(265, "Selamat Hari Raya Idul Fitri 1 Syawal 1441 H");

  nama = readString(67);
  Serial.print("67 Nama Masjid  : "); Serial.println(nama);
  info1 = readString(117);
  Serial.print("117 Informasi 1 : "); Serial.println(info1);
  info2 = readString(167);
  Serial.print("167 Informasi 2 : "); Serial.println(info2);
  info3 = readString(217);
  Serial.print("217 Informasi 3 : "); Serial.println(info3);
  info4 = readString(267);
  Serial.print("267 Informasi 4 : "); Serial.println(info4);
  Serial.println();
