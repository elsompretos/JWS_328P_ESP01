...
15 adj_subuh : 2   | 31 tpl_subuh : 0
17 adj_dzuhur : 2  | 33 tpl_dzuhur : 2
19 adj_ashar : 2   | 35 tpl_ashar : 3
21 adj_maghrib : 2 | 37 tpl_maghrib : 4
23 adj_isya : 2    | 39 tpl_isya : 5
25 adj_imsak : 2   | 41 tpl_imsak : 6
27 adj_terbit : 2  | 43 tpl_terbit : 7
29 adj_dhuha : 2   | 45 tpl_dhuha : 8


47 iqm_subuh : 3   | 59 lama_imsak : 0
49 iqm_dzuhur : 3  | 61 sesuaikan_tgl_hijriyah : 1
51 iqm_ashar : 3   | 63 sesuaikan_bright : 15
53 iqm_maghrib : 3 | 65 sesuaikan_volume : 20
55 iqm_isya : 3
57 lama_adzan : 4

67 Nama Masjid  : Masjid Raya Akbar Maulana - Ampera Raya
117 Informasi 1 : Jadikan Sabar dan Sholat Sebagai Penolongmu
167 Informasi 2 : Sedekah Melancarkan Rezekimu
217 Informasi 3 : Subhanallah Walhamdulillah Laailahaillalhah
267 Informasi 4 : Selamat Hari Raya Idul Fitri 1 Syawal 1441 H
*/
...
switch (mode) {
    ...
    if (tx_ser.length() > 0){
        // Setting Jam === SJ=11-40-00-30-06-2020-01-15-20 4 digit terakhir (10-15) = brightness-volume
        if(tx_ser.substring(0,2) == "SJ"){
          ...
          EEPROM.put(61, tx_ser.substring(23,25).toInt()); // Adj Hijriyah
          EEPROM.put(63, tx_ser.substring(26,28).toInt()); // Adj Kecerahan
          EEPROM.put(65, tx_ser.substring(29,31).toInt()); // Adj Volume
       ...
       // Setting lama Iqomah === IQ=02-02-02-02-02-04 === IQ=01-01-01-01-01-02
          ...
          Serial.println(tx_ser);
          EEPROM.put(47, tx_ser.substring(3,5).toInt());
          EEPROM.put(49, tx_ser.substring(6,8).toInt());
          EEPROM.put(51, tx_ser.substring(9,11).toInt());
          EEPROM.put(53, tx_ser.substring(12,14).toInt());
          EEPROM.put(55, tx_ser.substring(15,17).toInt());
          EEPROM.put(57, tx_ser.substring(18,20).toInt());
...
void TPL_HH_TGL(int pilih){           // MENAMPILKAN TANGGAL HIJRIYAH
  ...
  String str_tanggal_hijriyah;
    ...
    str_tanggal_hijriyah = readString(67);
  }
    ...
    str_tanggal_hijriyah = readString(117); 
  }
...
void TPL_HH_WKT_MSK(){                // MENAMPILKAN WAKTU MASUK ADZAN
    ...
    WAKTU();
    int b_lama_adzan;
    EEPROM.get(57, b_lama_adzan);
    int b_lama_imsak;
    EEPROM.get(59, b_lama_imsak); // harus 0
    int b_lama;
...
void TPL_QD_IQM(){                    // MENAMPILKAN IQOMAH
  WAKTU();
    ...
    EEPROM.get(47, b_iqm_sbh);
    EEPROM.get(49, b_iqm_dzr);
    EEPROM.get(51, b_iqm_asr); 
    EEPROM.get(53, b_iqm_mgr); 
    EEPROM.get(55, b_iqm_isy); 
